var map = new mapboxgl.Map({ //create a map in div and center it
    container: 'map', //this is div id
...
map.addControl(new MapboxGeocoder({
    accessToken: mapboxgl.accessToken //this give us search capability
}));

map.on('load', function() { //when map loads than go and execute this function
